...
-- main Pokemon table
INSERT INTO pokemon (
    name, species, height, weight, primary_ability_id, hidden_ability_id, primary_type_id, secondary_type_id, habitat_id
)
VALUES (
    'Pikachu', 'Mouse Pokémon', 0.40, 6.00, 1, 2, 4, NULL, 2
);